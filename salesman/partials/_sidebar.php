        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="user.php">
              <i class="fas fa-users text-primary"></i> Manage Customer
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="javascript:void(0);" class="nav-link" data-toggle="collapse" data-target="#submenu-inventory" aria-expanded="false" aria-controls="submenu-inventory">
              ...
              <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                  <a class="nav-link" href="restock.php">
                    <i class="fas fa-sliders-h nav-icon text-primary"></i> Restock
                  </a>
                </li>
                <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="distribution.php">
              <i class="ni ni-credit-card text-primary"></i> Distribution
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="exp_log.php">
              <i class="nav-icon fas fa-wallet text-primary"></i> Expense Log
            </a>
          </li>
          <li class="nav-item">
