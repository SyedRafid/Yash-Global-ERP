...
$sql = "SELECT * 
        ...
        WHERE expense.salesman_id = ?
        ORDER BY ex_id DESC
        LIMIT ? OFFSET ?";

// Prepare the statement
$stmt = $mysqli->prepare($sql);
$stmt->bind_param("iii", $admin_id, $recordsPerPage, $offset);
$stmt->execute();
...
$totalRecordsSql = "SELECT COUNT(*) AS total FROM expense WHERE expense.salesman_id = $admin_id";
