                            ...
                            <table class="table table-striped table-hover align-items-center table-flush" style="text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    $ret = "SELECT sales_area.*, 
                                            ...
                                            FROM sales_area 
                                            LEFT JOIN user AS changer ON sales_area.cngUser = changer.id
                                            LEFT JOIN user AS salesman ON sales_area.saSalesman_id = salesman.id 
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td scope="col"><?php echo $order->salesman_name; ?></td>
