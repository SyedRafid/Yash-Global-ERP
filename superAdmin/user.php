...
$title = "Manage Users - Yash Global SDNBHD";
          ...
          <div class="card shadow">
            ...
            <div class="form-row">
              <div class="col-12 text-center mb-2">
                <h5 class="text-success border border-success rounded py-2 px-3 mb-4 mt-1" style="font-size: 16px; display: inline-block;"><i class="fas fa-user-tie">&nbsp;&nbsp;</i>ADMIN</h5>
              </div>
            </div>
            <div class="table-responsive mb-5" style="border-bottom: 2px solid #e4e4e4;">
              <table class="table align-items-center table-flush" style="text-align: center;">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM user WHERE userType = 2 ORDER BY id ASC";
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="user.php?delete=<?php echo $cust->id; ?>">
                          <button class="btn btn-sm btn-danger">
                            <i class="fas fa-trash"></i>
                            Delete
                          </button>
                        </a>
                        <a href="update_user.php?update=<?php echo $cust->id; ?>">
            ...
            <div class="form-row">
              <div class="col-12 text-center mb-2">
                <h5 class="text-success border border-success rounded py-2 px-3 mb-4 mt-1" style="font-size: 16px; display: inline-block;"><i class="fas fa-user-tie">&nbsp;&nbsp;</i>SALESMAN</h5>
              </div>
            </div>
            <div class="table-responsive mb-5" style="border-bottom: 2px solid #e4e4e4;">
              <table class="table align-items-center table-flush" style="text-align: center;">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM user WHERE userType = 3 ORDER BY id ASC";
                  $stmt = $mysqli->prepare($ret);
                  $stmt->execute();
                  $res = $stmt->get_result();
                  while ($cust = $res->fetch_object()) {
