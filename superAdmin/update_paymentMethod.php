...
$update = $_GET['update'];
if ($update == 1) {
    $info = "Default payment cannot be Updated!!";
...
if (isset($_POST['update'])) {
    ...
    if (empty($_POST["name"]) || empty($_POST["account"])  || empty($_POST["status"])) {
        ...
        $postQuery = "UPDATE payment SET name =?, account =?, note =?, status =? WHERE pay_id = ?";
        $postStmt = $mysqli->prepare($postQuery);
        //bind paramaters
        $postStmt->bind_param('sisii', $name, $account, $note, $status, $update);
        $postStmt->execute();
...
<body>
    ...
    <div class="main-content">
        ...
        $ret = "SELECT * FROM  payment WHERE pay_id = '$update' ";
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="name" id="name" class="form-control"
                                                placeholder="Enter expenditure purpose" value="<?php echo $pay->name; ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" name="account" id="account" class="form-control"
                                                placeholder="Enter amount in RM" value="<?php echo $pay->account; ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="status" id="status" class="form-control">
                                                <option value="1" <?php echo ($pay->status == 1) ? 'selected' : ''; ?>>Active</option>
                                                <option value="2" <?php echo ($pay->status == 2) ? 'selected' : ''; ?>>Inactive</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="note" id="note" class="form-control"
                                                placeholder="Enter additional note" value="<?php echo $pay->note; ?>">
                                        </div>
                                    </div>
