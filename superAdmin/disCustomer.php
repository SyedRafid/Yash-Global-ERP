...
$title = "Customer Distribution - Yash Global SDNBHD";
...
<body>
                    ...
                    <div class="card shadow" style="padding: 20px;">
                        <div class="card-header border-0">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                $productCount = 0;
                                $query = "SELECT COUNT(DISTINCT product_id) AS total_products FROM cart WHERE user_id = ?";
                                ...
                                ?>
                                <a href="cmCart.php" class="btn btn-primary d-flex align-items-center">
    ...
    <script>
        function resetSearch() {
            ...
            window.location.href = 'disCustomer.php';
        }
    </script>
                            ...
                            if (data.status === 'success') {
                                Swal.fire({
                                    ...
                                    if (buttonResult.isConfirmed) {
                                        ...
                                        window.location.href = 'cmCart.php';
                                    }
                                });
                            } else {
