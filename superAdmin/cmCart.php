...
check_login();
$title = "Customer Cart - Yash Global SDNBHD";
                        ...
                        <div class="container mb-5">
                            <?php if ($result->num_rows > 0): ?>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    <a href="disCustomer.php" class="btn btn-secondary btn-sm px-3 py-2">Select More</a>
                            ...
                            <?php else: ?>
                                ...
                                <div class="text-center mt-5">
                                    <a href="disCustomer.php" class="btn btn-primary">Add Products</a>
                                </div>
                            <?php endif; ?>
                        </div> <!-- row -->
                    </div>
            ...
            fetch('update_cart.php', {
                ...
                .catch(error => {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Something went wrong while updating the customer cart!',
                        confirmButtonText: 'OK'
                    }).then(() => {
                        location.reload();
                    });
