          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="col-12 text-center mb-4" style="border-bottom: 2px solid #e4e4e4;">
                <h5 class="text-success border border-success rounded py-2 px-3 mb-4 mt-1" style="font-size: 16px; display: inline-block;">Inventory History</h5>
              </div>
            </div>
                      ...
                      <td>
                        ...
                        switch ($prod->type) {
                          ...
                          case "UPDATE":
                            ...
                            break;
                          case "OUT":
                            echo "<b style='color: #8f03ff;'>$prod->quantity</b>";
                            break;
                          case "SELL":
                      ...
                      <td>
                        ...
                        switch ($prod->type) {
                          ...
                          case "UPDATE":
                            ...
                            break;
                          case "OUT":
                            echo "<b style='color: #8f03ff;'>$prod->type</b>";
                            break;
                          case "SELL":
